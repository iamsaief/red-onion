...
const Order = () => {
  ...
  const renderCartItems = () => {
    return cartItems.map(({ title, price, id, quantity }) => (
        ...
        <div className="row">
          <div className="col-md-7">
            <div className="order-delivery">
              ...
              <form className="rd-form py-5">
                ...
                <div className="form-group">
                  <textarea className="form-control" name="address" placeholder="Full Address"></textarea>
                </div>
          ...
          <div className="col-md-5">
            <div className="order-cart">
              ...
              <div className="order-cart-items">{cartItems.length ? renderCartItems() : "Cart is Empty"}</div>
